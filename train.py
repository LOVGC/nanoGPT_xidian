...
def main() -> None:
    ...
    for step in range(1, args.max_steps + 1):
        ...
        if step % args.log_interval == 0:
            ...
            eta_seconds = (args.max_steps - step) * avg_step_time
            print(
                f"step {step}/{args.max_steps} | train_loss {loss.item():.4f} | lr {lr:.2e} | ETA {format_eta(eta_seconds)}"
            )
            append_log(
                log_path,
                step,
